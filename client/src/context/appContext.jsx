...
const AppProvider = ({ children }) => {
  ...
  const authFetch = axios.create({
    baseURL: "https://jobtrack-umb0.onrender.com/api/v1",
  });
  ...
  const registerUser = async (currentUser) => {
    ...
    try {
      const response = await axios.post("https://jobtrack-umb0.onrender.com/api/v1/auth/register", currentUser);
  ...
  const loginUser = async (currentUser) => {
    ...
    try {
      const response = await axios.post(`https://jobtrack-umb0.onrender.com/api/v1/auth/login`, currentUser);
      const { user, token, location } = response.data;
      dispatch({
  ...
  const updateUser = async (currentUser) => {
    ...
    try {
      const { data } = await authFetch.patch(`https://jobtrack-umb0.onrender.com/api/v1/auth/updateUser`, currentUser);
